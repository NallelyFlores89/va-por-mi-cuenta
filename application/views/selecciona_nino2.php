            ...
            <div class="col-md-4">
              <div class="foto">
                ...
                <div class="col-md-12" id="flechas">
                  <div class="fAnt col-xs-12 col-md-6">
                    <button class="anterior col-xs-12" type="button">
                      <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>Anterior
                    </button>
                  </div>
                  <div class="fSig col-xs-12 col-xs-12 col-md-6">
              ...
              <div class="biografia col-md-12">
                <div class="biografiaChild col-md-12">
                  ...
                  <div class="datoNino col-md-12">
                    ...
                    <?php if(isset($mes[$ninos[0]['fNacMes']])){?>                    
                  ...
                  <div class="datoNino col-md-12">
                    ...
                    <?php }else{ ?>
                    <div class="bn_fn datoNino2 col-md-10">Sin registro</div>
                    <?php } ?>
                  </div>
                  <div class="datoNino col-md-12">
