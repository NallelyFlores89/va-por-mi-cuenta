    ...
    <div class="col-md-8">
      ...
      <div class="botonApadrinar col-md-6">
        <form method="post" action="<?= base_url()?>index.php/apadrina/paso3">
          ...
          <input class="col-xs-12 apadrinaNinoBtn boton" type="submit" value="Apadrinar">
          <?php } else{ ?>
          <input class="col-xs-12 apadrinaNinoBtn botonYaPadrino" type="submit" value="Ya tengo padrino" disabled="disabled">
          <?php }?>
        </form>
      </div>
