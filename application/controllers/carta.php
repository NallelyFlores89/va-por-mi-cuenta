...
class Carta extends CI_Controller{
    ...
    function creaPDF(){
        ...
        $cabecera = '<div><img src="http://yosoypadrinovapormicuenta.com/media/img/logovxmc-carta.png" style="float:left">';
        $cabecera = $cabecera.'<img src="http://yosoypadrinovapormicuenta.com/media/img/logoalsea-carta.png" style="float:right"></div><br><br>';
