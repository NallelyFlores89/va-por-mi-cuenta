                            ...
                            <div class="contenido">
                                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <input type="password" name="password" placeholder="6 dígitos incluyendo ceros">
                                        </div>
                                        <label class="col-xs-12 col-sm-12 aviso">Si eres colaborador de Vips o El Portón tu contraseña es la misma que utilizaste para ingresar al e-Learning del Movimiento (enviada por Capacitación Corporativa)</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                                    ...
                                    <input type="submit" value="Login" class="btn btn-primary boton login pull-right"/>
                                </div>
