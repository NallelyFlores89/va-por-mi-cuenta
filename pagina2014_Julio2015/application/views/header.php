<div class="cajaHeader">
	<div id="header" class="row">
		...
		<div id="redesSociales" class="col-md-2 col-md-offset-3">
			<div class="col-md-4"><a target="_blank" href="mailto:vapormicuenta@alsea.com.mx?Subject=Hola"><img src="<?= base_url()?>media/img/icon-mail.png"></a></div>
			<div class="col-md-4"><a target="_blank" href="https://twitter.com/VaXMiCuenta"><img src="<?= base_url()?>media/img/icon-tw.png"></a></div>
			<div class="col-md-4"><a target="_blank" href="https://www.facebook.com/vapormi?fref=ts"><img src="<?= base_url()?>media/img/icon-fb.png"></a></div>
		</div>
	</div>
